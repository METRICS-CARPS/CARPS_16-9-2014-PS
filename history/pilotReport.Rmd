...
# d for Others
reportObject <- reproCheck(reportedValue = ".08", obtainedValue =  other %>% pull(d_1_2), valueType = "d")
...
The sample sizes reported in the paper differed from the ones obtained. Given the large numbers, the deviations were only minor. All, except one, inferential and summary statistics could be successfully reproduced. The deviation was in the second decimal and might come from a rounding error. In sum, given the large data set and the large number of compared values, this check was rather successful.
...
locus_specification <- 20 # how many discrete issues did you encounter that related to incomplete, incorrect, or unclear specification of the original analyses?
locus_analysis <- 4 # how many discrete issues did you encounter that related to errors in the authors' original analyses?
